...
with open('model/modellink.pkl', 'rb') as file:
...
url_input = st.text_input('Enter URL to classify:', '')

if st.button('Predict'):
    if url_input:
        prediction_int, prediction_label = model_predict(url_input)
        st.write(f'Prediction: {prediction_label} (Class {prediction_int})')
    else:
